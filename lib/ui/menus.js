...
const { colors, CONFIG_DIR, BACKUP_DIR, CONFIGS_DIR, CACHE_DIR, SECRETS_DIR, OPENCODE_CONFIG_FILE, DEFAULTS, AGENT_PROFILES, CONFIG_FILE, AGENT_PRIORITY_ORDER } = require('../constants');
